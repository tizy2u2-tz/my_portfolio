...
export const projects: Project[] = [
  {
    ...
    role: 'Lead Designer. Creative concepting was a collaboration with a design agency. Owned creative direction, visual identity, campaign style guide development, and multi-channel asset production. Collaborated with other designers on the team for social and other campaign assets.',
    ...
    approach: 'Developed a comprehensive campaign style guide that established the visual foundation for the entire campaign. The creative centers on quiet strength under pressure—leading without panic, responding with clarity amid chaos. A tribute to the emotional resilience that defines true leadership in uncertain times. Human-centered imagery creates a personal, empathetic connection with the audience. The style guide ensured visual consistency across all touchpoints, from landing pages targeting different audiences to social media assets and motion graphics.',
  ...
  },
  {
    ...
    approach: 'Developed a comprehensive visual system with bold colors and clear messaging optimized for quick viewing at scale. The creative process began with exploring multiple OOH design concepts, evaluating different approaches to visual hierarchy, messaging clarity, and impact at scale. Two distinct OOH directions were developed, each testing how the brand could stand out in Las Vegas\'s competitive advertising landscape. Simultaneously, explored multiple booth design concepts, evaluating each for visibility, engagement potential, and brand consistency. The creative process involved iterating through three distinct booth approaches—each exploring different spatial layouts, visual hierarchies, and interaction opportunities. The final designs seamlessly connected the outdoor OOH campaign with the on-site booth experience, creating a cohesive brand journey from street-level awareness to conference floor engagement. Designed booth elements that created an immersive brand experience, ensuring consistency from outdoor advertising to on-site engagement. Created eye-catching visuals that worked across billboards, vehicle wraps, and interactive booth spaces.',
